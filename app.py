...
def main():
    ...
    browserManager.open_multiple_tabs(restaurants)
    print("All tabs opened successfully.")
    # Здесь можно добавить код для обработки каждой вкладки и извлечения отзывов
    data = browserManager.parse_all_tabs(restaurants)
